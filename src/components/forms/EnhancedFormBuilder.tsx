...
const EnhancedFormBuilder: React.FC<EnhancedFormBuilderProps> = ({ formId, onBack }) => {
  ...
  const renderFieldEditor = () => {
    ...
    return (
      <div className="bg-white border-l border-gray-200 p-6 w-80 shadow-lg">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <input
                ...
                className="text-xl font-bold bg-transparent border-none focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-lg px-2 py-1"
              />
            ...
            <div className="flex items-center space-x-2">
              ...
              <button 
                onClick={saveForm}
                disabled={saving}
                className="flex items-center space-x-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 shadow-lg"
              >
              ...
              <button 
                ...
                className="flex items-center space-x-2 px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:opacity-50 shadow-lg"
              >
              ...
              {form.status === 'published' && form.shareUrl && (
                <>
                  <button
                    ...
                    className="flex items-center space-x-2 px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 shadow-lg"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 shadow-lg"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 shadow-lg"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 shadow-lg"
                  >
                ...
                <div className="bg-white rounded-xl shadow-xl border border-gray-200 p-8">
                  <div className="mb-8">
                    <input
                      ...
                      value={form.title}
                      onChange={(e) => setForm(prev => ({ ...prev, title: e.target.value }))}
                      className="text-2xl font-bold text-gray-900 bg-transparent border-none focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-lg px-2 py-1 w-full"
